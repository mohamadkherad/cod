...
import { IWebviewService, WebviewContentOptions, WebviewElement, WebviewIcons, WebviewOptions, WebviewOverlay, WebviewExtensionDescription } from 'vs/workbench/contrib/webview/browser/webview';
...
export class ElectronWebviewService implements IWebviewService {
	...
	createWebviewElement(
		...
		if (useExternalEndpoint) {
			...
			return this._instantiationService.createInstance(IframeBasedElectronWebview, id, options, contentOptions, extension, this._webviewThemeDataProvider);
		}
	}
